...
/**
* @see \App\Http\Controllers\CheckinController::createCheckinMedianteReserva
 * @see app/Http/Controllers/CheckinController.php:101
 * @route '/recepcion/{reserva}/checkins/create'
 */
export const createCheckinMedianteReserva = (args: { reserva: number | { id: number } } | [reserva: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: createCheckinMedianteReserva.url(args, options),
    method: 'get',
})

createCheckinMedianteReserva.definition = {
    methods: ["get","head"],
 ...
 * @route '/recepcion/{reserva}/checkins/create'
 */
createCheckinMedianteReserva.url = (args: { reserva: number | { id: number } } | [reserva: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return createCheckinMedianteReserva.definition.url
 ...
 * @route '/recepcion/{reserva}/checkins/create'
 */
createCheckinMedianteReserva.get = (args: { reserva: number | { id: number } } | [reserva: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: createCheckinMedianteReserva.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/recepcion/{reserva}/checkins/create'
 */
createCheckinMedianteReserva.head = (args: { reserva: number | { id: number } } | [reserva: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: createCheckinMedianteReserva.url(args, options),
    method: 'head',
})
 ...
 * @route '/recepcion/{reserva}/checkins/create'
 */
    const createCheckinMedianteReservaForm = (args: { reserva: number | { id: number } } | [reserva: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: createCheckinMedianteReserva.url(args, options),
        method: 'get',
    })
 ...
 * @route '/recepcion/{reserva}/checkins/create'
 */
        createCheckinMedianteReservaForm.get = (args: { reserva: number | { id: number } } | [reserva: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: createCheckinMedianteReserva.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/recepcion/{reserva}/checkins/create'
 */
        createCheckinMedianteReservaForm.head = (args: { reserva: number | { id: number } } | [reserva: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: createCheckinMedianteReserva.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    createCheckinMedianteReserva.form = createCheckinMedianteReservaForm
/**
...
/**
* @see \App\Http\Controllers\CheckinController::searchClientes
...
/**
* @see \App\Http\Controllers\CheckinController::updateHabitacionEstado
 * @see app/Http/Controllers/CheckinController.php:244
 * @route '/habitaciones/estado'
 */
export const updateHabitacionEstado = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updateHabitacionEstado.url(options),
    method: 'put',
})

updateHabitacionEstado.definition = {
    methods: ["put"],
 ...
 * @route '/habitaciones/estado'
 */
updateHabitacionEstado.url = (options?: RouteQueryOptions) => {
    return updateHabitacionEstado.definition.url + queryParams(options)
}
 ...
 * @route '/habitaciones/estado'
 */
updateHabitacionEstado.put = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updateHabitacionEstado.url(options),
    method: 'put',
})
 ...
 * @route '/habitaciones/estado'
 */
    const updateHabitacionEstadoForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: updateHabitacionEstado.url({
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PUT',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/habitaciones/estado'
 */
        updateHabitacionEstadoForm.put = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateHabitacionEstado.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    updateHabitacionEstado.form = updateHabitacionEstadoForm
const CheckinController = { index, createCheckinMedianteReserva, show, edit, update, store, destroy, searchClientes, updateHabitacionEstado }
