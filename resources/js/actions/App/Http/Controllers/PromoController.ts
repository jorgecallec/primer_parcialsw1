...
/**
* @see \App\Http\Controllers\PromoController::toggleEstado
 * @see app/Http/Controllers/PromoController.php:399
 * @route '/promos/{promo}/toggle'
 */
export const toggleEstado = (args: { promo: number | { id: number } } | [promo: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/promos/{promo}/toggle'
 */
toggleEstado.url = (args: { promo: number | { id: number } } | [promo: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { promo: args }
    }
 ...
 * @route '/promos/{promo}/toggle'
 */
toggleEstado.post = (args: { promo: number | { id: number } } | [promo: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: toggleEstado.url(args, options),
    method: 'post',
})
 ...
 * @route '/promos/{promo}/toggle'
 */
    const toggleEstadoForm = (args: { promo: number | { id: number } } | [promo: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: toggleEstado.url(args, options),
        method: 'post',
    })
 ...
 * @route '/promos/{promo}/toggle'
 */
        toggleEstadoForm.post = (args: { promo: number | { id: number } } | [promo: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: toggleEstado.url(args, options),
            method: 'post',
        })
...
/**
* @see \App\Http\Controllers\PromoController::promocionesDisponibles
 * @see app/Http/Controllers/PromoController.php:446
 * @route '/promos/disponibles'
 */
export const promocionesDisponibles = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: promocionesDisponibles.url(options),
    method: 'get',
})

promocionesDisponibles.definition = {
    methods: ["get","head"],
 ...
 * @route '/promos/disponibles'
 */
promocionesDisponibles.url = (options?: RouteQueryOptions) => {
    return promocionesDisponibles.definition.url + queryParams(options)
}
 ...
 * @route '/promos/disponibles'
 */
promocionesDisponibles.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: promocionesDisponibles.url(options),
    method: 'get',
})
/**
 ...
 * @route '/promos/disponibles'
 */
promocionesDisponibles.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: promocionesDisponibles.url(options),
    method: 'head',
})
 ...
 * @route '/promos/disponibles'
 */
    const promocionesDisponiblesForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: promocionesDisponibles.url(options),
        method: 'get',
    })
 ...
 * @route '/promos/disponibles'
 */
        promocionesDisponiblesForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: promocionesDisponibles.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/promos/disponibles'
 */
        promocionesDisponiblesForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: promocionesDisponibles.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    promocionesDisponibles.form = promocionesDisponiblesForm
const PromoController = { index, create, store, show, edit, update, destroy, toggleEstado, validarCodigo, promocionesDisponibles }
