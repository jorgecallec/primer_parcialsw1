...
/**
* @see \App\Http\Controllers\ServicioController::subirImagen
 * @see app/Http/Controllers/ServicioController.php:159
 * @route '/servicios/{servicio}/imagenes'
 */
export const subirImagen = (args: { servicio: number | { id: number } } | [servicio: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/servicios/{servicio}/imagenes'
 */
subirImagen.url = (args: { servicio: number | { id: number } } | [servicio: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { servicio: args }
    }
 ...
 * @route '/servicios/{servicio}/imagenes'
 */
subirImagen.post = (args: { servicio: number | { id: number } } | [servicio: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: subirImagen.url(args, options),
    method: 'post',
})
 ...
 * @route '/servicios/{servicio}/imagenes'
 */
    const subirImagenForm = (args: { servicio: number | { id: number } } | [servicio: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/servicios/{servicio}/imagenes'
 */
        subirImagenForm.post = (args: { servicio: number | { id: number } } | [servicio: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: subirImagen.url(args, options),
            method: 'post',
        })
...
/**
* @see \App\Http\Controllers\ServicioController::eliminarImagen
...
const ServicioController = { index, create, store, show, edit, update, galeria, subirImagen, eliminarImagen }
